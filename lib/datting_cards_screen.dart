...
import 'firebase_db_class.dart';

class DattingCards extends StatefulWidget {
  const DattingCards({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DattingCardsState createState() => _DattingCardsState();
}

class _DattingCardsState extends State<DattingCards> {
  final DatabaseReference _userRef = FirebaseService().getUserReference();
  ...
  void initState() {
    ...
    // Listen to real-time changes in the user data
    _userRef.onValue.listen((event) {
      // Handle changes in user data here
